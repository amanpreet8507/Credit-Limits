This C++ Program determines whether a department-store customer has exceeded the credit limit on a change account. For each customer, the following facts are available:
